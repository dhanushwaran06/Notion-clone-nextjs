...
const Item = ({
  ...
  return (
    <div
      ...
      className={cn(
        "group min-h-[27px] text-sm py-1 pr-3 w-full hover:bg-primary/5 flex items-center text-muted-foreground font-medium active",
    ...
    >
      ...
      {documentIcon ? (
        <div className="shrink-0 mr-2 text-[180px]">{documentIcon}</div>
      ) : (
        <Icon className="shrink-0 h-[18px] w-[18px] mr-2 text-muted-foreground" />
      )}
      <span className="truncate">{lablel}</span>
      {isSearch && (
        <kbd
